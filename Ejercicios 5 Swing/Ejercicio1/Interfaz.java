...
public class Interfaz extends JFrame{
    ...
    public JButton borrarBtn, copiarBtn;
    public JTextField textfield;
    public JLabel label, resultLbl;
